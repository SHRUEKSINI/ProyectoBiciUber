...
def insert_user(facturaPost: facturaDB):
    insert_query = """
    INSERT INTO factura (numero_de_factura,fecha_de_expedicion,nombre,descripcion_productos,cantidad,metodo_de_pago,nit)
    VALUES (%s,%s,%s,%s,%s,%s,%s)
    """
    values = (facturaPost.numero_de_factura,facturaPost.fecha_de_expedicion,facturaPost.nombre,facturaPost.descripcion_productos,facturaPost.cantidad,facturaPost.metodo_de_pago,facturaPost.nit)
